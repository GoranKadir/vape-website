        ...
        >
          <div className="modal-dialog">
            <div className="modal-content">
              ...
              <div className="modal-body">ddsfdsfdsfsdfdsfdsf</div>
        ...
        <div className="row justify-content-center">
          ...
          <div className="col-12 col-lg-3">
            <div className="card my-5">
              ...
              <h5 className="card-title text-light text-center">Alpha</h5>
          ...
          <div className="col-12 col-lg-3">
            <div className="card my-5">
              ...
              <h5 className="card-title text-light text-center">Cool mint</h5>
              <a href="#" className="btn btn-light">
                Läs mer
              </a>
            </div>
          ...
          <div className="col-12 col-lg-3">
            <div className="card my-5">
              ...
              <h5 className="card-title text-light text-center">Ice Mango</h5>
              <a href="#" className="btn btn-light">
                Läs mer
              </a>
            </div>
          ...
          <div className="col-12 col-lg-3">
            <div className="card my-5">
              ...
              <h5 className="card-title text-light text-center">Guava Ice</h5>
              <a href="#" className="btn btn-light">
                Läs mer
              </a>
            </div>
          ...
          <div className="col-12 col-lg-3">
            <div className="card my-5">
              <img src={iceCola} alt="..." />
              <h5 className="card-title text-light text-center">Ice Cola</h5>
              <a href="#" className="btn btn-light">
                Läs mer
              </a>
            </div>
          ...
          <div className="col-12 col-lg-3">
            <div className="card my-5">
              <img src={lushIce} alt="..." />
              <h5 className="card-title text-light text-center">Lush Ice</h5>
              <a href="#" className="btn btn-light">
                Läs mer
              </a>
            </div>
          ...
          <div className="col-12 col-lg-3">
            <div className="card my-5">
              ...
              <h5 className="card-title text-light text-center">Peach Ice</h5>
              <a href="#" className="btn btn-light">
                Läs mer
              </a>
            </div>
